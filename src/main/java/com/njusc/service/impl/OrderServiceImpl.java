...
import com.njusc.dao.*;
import com.njusc.pojo.*;
...
import com.njusc.vo.OrderItemVo;
import com.njusc.vo.OrderProductVo;
import com.njusc.vo.OrderVo;
import com.njusc.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId, Integer shippindId) {
        ...
        // 生成订单
        Order order = this.assembleOrder(userId, shippindId, payment);
        if (order == null) {
    ...
    public ServerResponse<String> cancel(Integer userId, Long orderNo) {
        ...
        int resutCount = orderMapper.updateByPrimaryKeySelective(updateOrder);
        if (resutCount > 0) {
